...
import com.deepak.behavioral.memento.commands.ColorCommand;
import com.deepak.behavioral.memento.commands.MoveCommand;
    ...
    private void attachMouseListeners() {
        MouseAdapter colorizer = new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                com.deepak.behavioral.memento.shapes.Shape target = editor.getShapes().getChildAt(e.getX(), e.getY());
                if (target != null) {
